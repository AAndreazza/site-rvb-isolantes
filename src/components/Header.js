            ...
            <header className='absolute inset-x-0 top-0 z-50'>
                <nav className='flex items-center justify-between p-5 lg:px-8' aria-label='Global'>
                    ...
                    <div className='hidden lg:flex lg:gap-x-14'>
                        ...
                        <Link to='' className='text-xl font-normal leading-6 text-gray-200'>Empresa</Link>
                        <Link to='' className='text-xl font-normal leading-6 text-gray-200'>Produtos</Link>
                        <Link to='' className='text-xl font-normal leading-6 text-gray-200'>Contato</Link>
                        <Link to='' className='text-xl font-normal leading-6 text-gray-200'>Políticas</Link>
                        <Link to='' className='text-xl font-normal leading-6 text-gray-200'>Blog</Link>
                    </div>
                        ...
                        <div className='mt-6 flow-root'>
                            <div className='-my-6 divide-y divide-gray-500/10'>
                                <div className='space-y-2 py-6'>
                                    ...
                                    <Link to='' className='-mx-3 block rounded-lg px-3 py-2 text-xl font-light leading-7 text-gray-200 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>Empresa</button></Link>
                                    ...
                                    <Link to='' className='-mx-3 block rounded-lg px-3 py-2 text-xl font-light leading-7 text-gray-200 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>Contato</button></Link>
                                    <Link to='' className='-mx-3 block rounded-lg px-3 py-2 text-xl font-light leading-7 text-gray-200 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>Políticas</button></Link>
                                    <Link to='' className='-mx-3 block rounded-lg px-3 py-2 text-xl font-light leading-7 text-gray-200 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>Blog</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
