    ...
    return (
        <div className='bg-[#041537]'>
            ...
            <div className='relative py-32 sm:py-56'>
                ...
                <p className='mt-4 mx-auto text-center font-montserrat text-base sm:text-3xl font-bold text-[#e4d5e7]'>BLINDAGEM ELETROSTÁTICA</p>
                <HeaderProdutos />
            </div>

            <h1 className='mt-20 xl:ml-24 ml-10 text-left text-[#a0a9cf] text-5xl xl:text-6xl tracking-wide font-extralight'>BLINDAGEM ELETROSTÁTICA</h1>
...
export default BlindagemEstatica